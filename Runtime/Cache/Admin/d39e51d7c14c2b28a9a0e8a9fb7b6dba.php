...
<body>
	...
	<div class="cf">
		<div class="fl">
			<a class="btn" href="<?php echo U('Center/add');?>">添 加</a>
		...
		<div class="search-form fr cf">
			<div class="sleft">
				<input type="text" name="repair" class="search-input" value="<?php echo I('repair');?>" placeholder="请输入保修人名称或保修单号">
	...
	<div class="data-table table-striped">
		<table class="">
			...
			<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$repair): $mod = ($i % 2 );++$i;?><tr>
						<td><input class="ids" type="checkbox" name="" value="<?php echo ($repair["id"]); ?>" /></td>
